...
namespace ProFind.Lib.ProfessionalNS.Views.CRUDPage.SecurityAnswerProfessionalsNS.UpdatePage
{
    ...
    {
        Securityanswerprofessional id = new Securityanswerprofessional();
        ...
        {
            var toUpdapteAnswerProfessional = new Securityanswerprofessional(Answer1_tb.Text, Answer2_tb_tb.Text);
